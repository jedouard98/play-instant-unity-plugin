...
namespace GooglePlayInstant.Editor
{
    public class PlayInstantQuickDeployWindow : EditorWindow
    {
        ...
        private void OnGuiDeployBundleSelect()
        {
            ...
            DeployBundleTextFields.LocalAssetBundlePath =
                EditorGUILayout.TextField(DeployBundleTextFields.LocalAssetBundlePath,
            ...
            DeployBundleTextFields.RemoteBucketName = EditorGUILayout.TextField(DeployBundleTextFields.RemoteBucketName,
                GUILayout.MinWidth(FieldMinWidth));
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.Space();
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Cloud Storage File Name", GUILayout.MinWidth(FieldMinWidth));
            DeployBundleTextFields.RemoteObjectName = EditorGUILayout.TextField(DeployBundleTextFields.RemoteObjectName,
                GUILayout.MinWidth(FieldMinWidth));
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.Space();
            EditorGUILayout.BeginHorizontal();
